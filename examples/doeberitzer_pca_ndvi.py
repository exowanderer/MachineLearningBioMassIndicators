"""Run File for Operating PCA NDVI with CLI"""
...
if __name__ == "__main__":
    ...
    args = ArgumentParser(prog="Doeberitzer PCA NDVI")
    args.add_argument(
        "--geojson",
        type=str,
    ...
    info_message("Generate JP2 PCANDVI Instance")
    jp2_data = PCANDVI(
